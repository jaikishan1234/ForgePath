        ...
        {mode === "manual" && (
          <>
            ...
            <Section title="Certifications (Optional)">
              <Field label="Certifications (comma separated)" value={certs} onChange={setCerts} placeholder="AWS Developer, Google Analytics...."/>
            </Section>
          </>
        )}
        ...
        {mode === "improve" && (
          <>
            <div
              ...
              className="glass-card border-dashed border-white/15 flex flex-col items-center justify-center gap-3 py-10 cursor-pointer hover:border-orange-500/40 hover:bg-white/2 transition-all duration-300 group"
            >
        ...
        {loading && (
          <div className="flex flex-col items-center justify-center py-20 gap-4">
            ...
            <p className="text-white/40 text-sm">
              ForgePath is building your ATS-optimized resume...
            </p>
          </div>
        )}
