    ...
    <div className="glass-card overflow-hidden">
      ...
      >
        <div className="flex gap-3 items-start">
          <span className="text-xs font-bold text-orange-400 mt-0.5">
            Q{q.id}
          </span>
          <div>
      ...
      <div className="max-w-3xl mx-auto flex flex-col gap-4">
          ...
          <div className="glass-card p-6 flex flex-col gap-5">
            <div className="flex flex-col gap-2">
              ...
              <input
                ...
                className="flex-1 bg-white/5 border border-white/10 rounded-xl px-4 py-2.5 text-sm text-white placeholder-white/25 outline-none focus:border-orange-500/50 transition-colors"
              />
            </div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <textarea
                ...
                className="bg-white/5 border border-white/10 rounded-xl px-4 py-2.5 text-sm text-white placeholder-white/25 outline-none focus:border-orange-500/50 transition-colors"
              />
            </div>
          </div>
        )}
        ...
        {mode === "resume" && (
          <div
            ...
            className="glass-card border-dashed border-orange-500/20 flex flex-col items-center justify-center gap-3 py-10 cursor-pointer hover:border-orange-500/40 hover:bg-white/2 transition-all duration-300 group"
          >
            <div className="w-14 h-14 rounded-2xl bg-orange-500/10 border-dashed border-orange-500/20 flex items-center justify-center group-hover:scale-105 transition-transform">
              {file ? (
        ...
        {!loading && (
          ...
          >
            <Code2 size={16} /> Generate Interview Questions
          </button>
        )}
        ...
        {loading && (
          <div className="flex flex-col items-center justify-center py-20 gap-4">
            ...
            <p className="text-white/40 text-sm">
              ForgePath is generating interview questions...
            </p>
          </div>
        )}
