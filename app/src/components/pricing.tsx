    ...
    <section id="pricing" className="py-24 px-6 md:px-12 max-w-7xl mx-auto">
      <div className="text-center mb-16">
        ...
        <p className="text-white/45 mt-4 max-w-2xl mx-auto leading-relaxed">
          Start with free resume analysis and job matching. Upgrade anytime for
          unlimited access and advanced career tools.
        </p>
        ...
        {plans.map((plan) => (
          <div
            ...
            className={`glass-card p-8 flex flex-col gap-6 relative transition-all duration-300 ${
              plan.highlight
                ? "border-orange-500/20 shadow-2xl shadow-orange-500/20 scale-[1.02]"
